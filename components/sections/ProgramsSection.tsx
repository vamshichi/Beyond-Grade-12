        ...
        <FadeUp className="mt-20">
          <div className="flex items-center gap-3 mb-10">
            ...
            <div className="flex items-center gap-2 px-4">
              ...
              <h3 className="font-serif text-3xl sm:text-4xl lg:text-5xl font-bold text-navy leading-tight tracking-tight">
                Exclusive{" "}
                <span className="text-[#c9a84c]">1-on-1 Mentorship</span>{" "}
                Programs
              </h3>
            </div>
            <div className="h-px flex-1 bg-gradient-to-r from-transparent via-charcoal/20 to-transparent" />
